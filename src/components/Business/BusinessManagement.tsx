...
export function BusinessManagement() {
  ...
  const [businessCreatedSuccess, setBusinessCreatedSuccess] = useState(false);
  ...
  const handleCreateBusiness = async (e: React.FormEvent) => {
    ...
    // FIX: Business ID should NOT be shown - it's auto-generated by database
    // Remove adminId from user input, let system generate it
    const businessData = {
    ...
    try {
      const newBusinessResult = await addBusiness(businessData) as any;

      // Store created business data
      setCreatedBusinessData(newBusinessResult);
      setBusinessCreatedSuccess(true);
      ...
      alert(`Business created successfully!\n\nBusiness ID: ${newBusinessResult?.id || 'Generated'}\nSubscription: ${businessData.subscription}\n\nAn admin account has been automatically created.`);

      setShowCreateModal(false);
      setBusinessCreatedSuccess(false);
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-xl p-6 max-w-2xl w-full mx-4 max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={handleCreateBusiness} className="space-y-6">
              ...
              {/* Admin credentials are auto-generated by system - no manual input needed */}
