...
CREATE TABLE IF NOT EXISTS notifications (
    ...
    type VARCHAR(50) DEFAULT 'system' CHECK (type IN ('reminder', 'job', 'system', 'quotation_sent', 'job_completed')),
...
BEGIN
    ...
    IF NOT EXISTS (
        ...
        ALTER TABLE businesses ADD CONSTRAINT fk_businesses_admin FOREIGN KEY (admin_id) REFERENCES users(id) ON DELETE SET NULL;
    END IF;
    ...
    IF NOT EXISTS (
        ...
        ALTER TABLE jobs ADD CONSTRAINT fk_jobs_employee FOREIGN KEY (employee_id) REFERENCES users(id) ON DELETE SET NULL;
    END IF;
    ...
    IF NOT EXISTS (
        ...
        ALTER TABLE module_permissions ADD CONSTRAINT fk_module_permissions_granted_by FOREIGN KEY (granted_by) REFERENCES users(id) ON DELETE SET NULL;
    END IF;
    ...
    IF NOT EXISTS (
        ...
        ALTER TABLE models_3d ADD CONSTRAINT fk_models_3d_created_by FOREIGN KEY (created_by) REFERENCES users(id) ON DELETE SET NULL;
    END IF;
    ...
    IF NOT EXISTS (
        ...
        ALTER TABLE model_permissions ADD CONSTRAINT fk_model_permissions_granted_by FOREIGN KEY (granted_by) REFERENCES users(id) ON DELETE SET NULL;
    END IF;
